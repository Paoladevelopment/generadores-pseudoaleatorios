...
import { CorridasTable } from "../CorridasSymbolsTable/CorridasSymbolsTable";
...
export const Corridas = () => {
  ...
  return (
    <section>
      {corridasResult && (
        <>
          {/* <Table tableCols={['Corridas']} tableRows={rowDataCorridas} isPagination/> */}
          <CorridasTable currentCorridas={corridasShown} />
